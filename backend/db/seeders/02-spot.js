  ...
  async up (queryInterface, Sequelize) {
    await Spot.bulkCreate([
      ...
      },
      {
        ...
        description: "The Jefferson Memorial, a graceful and dignified structure in Washington, D.C., honors the third President of the United States, Thomas Jefferson, and his enduring contributions to American ideals. 1  Its circular, domed design, reminiscent of the Roman Pantheon, reflects Jefferson's admiration for classical architecture. 2  Inside, a towering bronze statue of Jefferson gazes thoughtfully toward the Tidal Basin, while excerpts from the Declaration of Independence, which he primarily authored, are inscribed on the memorial's interior walls. 3  The memorial's location, surrounded by cherry blossom trees that bloom each spring, adds to its serene and contemplative atmosphere. 4  More than just a monument, the Jefferson Memorial serves as a reminder of the principles of liberty, equality, and democracy that Jefferson championed, inviting visitors to reflect on the enduring relevance of his vision for the nation",
        price: 500.00,
        avgRating: 4,
        previewImage: "https://www.nps.gov/common/uploads/grid_builder/thje/crop16_9/A8A9235B-1DD8-B71B-0BC0B5BD83666D32.jpg?width=640&quality=90&mode=crop"
      },
      {
        ownerId: 5,
        ...
        description: "The Lincoln Memorial, a neoclassical masterpiece in Washington D.C., stands as a solemn and majestic tribute to the 16th President of the United States, Abraham Lincoln. Its imposing white marble structure houses a colossal statue of Lincoln, his gaze fixed thoughtfully across the Reflecting Pool towards the Washington Monument. The memorial's interior walls are inscribed with Lincoln's second inaugural address and the Gettysburg Address, powerful reminders of his leadership during a pivotal time in American history. The Lincoln Memorial is not merely a monument; it's a symbol of unity, perseverance, and the enduring ideals of democracy. Its steps have been the backdrop for countless historic moments, from Martin Luther King Jr.'s I Have a Dream speech to gatherings of citizens seeking inspiration and solace. The memorial's serene atmosphere and profound symbolism continue to resonate with visitors from around the world, making it a powerful and enduring testament to Lincoln's legacy.",
        price: 750.25,
        avgRating: 5,
        previewImage: "https://washington.org/sites/default/files/pixels.sh_visitors-to-the-lincoln-memorial-at-night_mydccool-via-crowdriff.jpg"
      },
      {
        ownerId: 6,
        ...
        lng: -88.01,
        name: "USS Alabama",
        description: "The USS Alabama, a majestic battleship anchored in Mobile Bay, Alabama, stands as a powerful symbol of American naval history and the sacrifices of those who served during World War II. This massive vessel, affectionately known as the Mighty A, boasts an impressive array of weaponry and a storied service record, having participated in numerous campaigns in the Pacific theater. Today, the USS Alabama Battleship Memorial Park offers visitors a unique opportunity to step back in time and explore the ship's decks, turrets, and living quarters, gaining insight into the daily lives of the sailors who called it home. Beyond the battleship itself, the park also showcases other military artifacts, including the submarine USS Drum and a collection of aircraft, making it a compelling destination for history enthusiasts and a poignant reminder of the nation's wartime heritage."
        ,price: 55.00,
        avgRating: 5,
        previewImage: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjQLamzmVXTi32UUIAd0gbgOOoEEEsMPqVbUNmQwtq_SNkzIELqR38nAVZeE8MXXAL60bj927sfYR6s7zoW7osRZ6KqJhxK_ZtRzxUAJ3-unIogGEW1sQppzavNrJjTK1_Esw7MY_ti11Ky/s1600/battleship+1.jpg"
      },
      {
        ownerId: 7,
        ...
        lng: -83.14152965,
        name: "Buc-ee's",
        description: "Buc-ee's transcends the typical gas station experience, morphing into a sprawling travel destination. These mega-sized centers, often record-holders for sheer size, boast a dizzying array of offerings, from hundreds of fuel pumps and burgeoning EV charging stations to an overwhelming selection of food and merchandise. Foodies revel in fresh barbecue, signature Beaver Nuggets, homemade fudge, and vast bakery selections, while shoppers peruse souvenirs, apparel, and home goods. Beyond the sheer volume, Buc-ee's is legendary for its immaculate restrooms and a vibrant, almost carnival-like atmosphere, all anchored by the iconic beaver mascot. Originating in Texas, Buc-ee's continues its expansion, bringing its unique blend of convenience, variety, and roadside charm to travelers across the Southern United States.",
        price: 800.00,
        avgRating: 4.5,
        previewImage: "https://bluebonnet.coop/sites/default/files/styles/focal_point_inpage_images/public/images/inpage/20240610_lhs_WorldsLargestBuc-ees.drone_.png?h=8b17d3df&itok=jbg8shB6"
      },
      {
        ownerId: 8,
      ...
      },
      {
        ...
        price: 2800.00,
        avgRating:  2.8,
        previewImage: "https://facilitiesmanagementadvisor.blr.com/app/uploads/sites/8/2025/02/Caesars-Superdome-768x512.png"
      },
      {
        ownerId: 10,
